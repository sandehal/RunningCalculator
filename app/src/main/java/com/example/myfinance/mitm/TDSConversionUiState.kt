...
data class ToSpeedConversionUiState(var timer: Int, var minutter: Int, var sekunder: Int, var distanseEnhet: EnhetDistanse, var distanse: Float, var resultUnit: Kmph) {
}
